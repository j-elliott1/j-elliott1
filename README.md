...
# 📁 Templates Directory
The /templates folder contains a growing collection of open-source professional templates designed to streamline IT operations, governance, and documentation. Each template follows industry best practices and can be freely used, customized, and shared under the MIT License.
Current examples include:

🧾 Vendor Risk Questionnaire: for assessing third-party vendors’ security, privacy, and compliance readiness

📋 Project and Operations Templates: for project charters, change logs, and SOP frameworks
